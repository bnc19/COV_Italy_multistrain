format_stan_cf_data= function(
  ...
  beta = c(
    posterior_sample_row$beta_M,
    posterior_sample_row$beta_A,
    posterior_sample_row$beta_O,
    posterior_sample_row$beta_Al
  )
  I0_ven = c(
    posterior_sample_row$I0_v_M,
    posterior_sample_row$I0_v_A,
    posterior_sample_row$I0_v_O,
    posterior_sample_row$I0_v_Al
  )
  rho_ven = posterior_sample_row$rho_v
  I0_it = c(
    posterior_sample_row$I0_i_M,
    posterior_sample_row$I0_i_A,
    posterior_sample_row$I0_i_O,
    posterior_sample_row$I0_i_Al
  )
