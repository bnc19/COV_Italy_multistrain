...
write.csv(cuminc2_df, "counterfactuals/Results/cuminc2_veneto.csv")
...
write.csv(cuminc3_df, "counterfactuals/Results/cuminc3_df_veneto.csv")
...
write.csv(cuminc3_df_sens, "counterfactuals/Results/cuminc3_df_sens_veneto.csv")
...
write.csv(cuminc4_df, "counterfactuals/Results/cuminc4_df_veneto.csv")
...
write.csv(cuminc5_df, "counterfactuals/Results/cuminc5_df_veneto.csv")
...
write.csv(cuminc6_df, "counterfactuals/Results/cuminc6_df_veneto.csv")
...
write.csv(cuminc7_df, "counterfactuals/Results/cuminc7_df_veneto.csv")
...
write.csv(modelfit1_df_italy, "counterfactuals/Results/modelfit1_df_italy.csv")
...
write.csv(cuminc1_df_italy, "counterfactuals/Results/cuminc1_df_italy.csv")
