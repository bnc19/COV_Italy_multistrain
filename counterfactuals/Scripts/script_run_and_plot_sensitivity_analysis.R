...
################    Run sensitivity analysis (Figure S8) ################   
...
posterior_samples_sens = read.csv("counterfactuals/Veneto/100_posterior_samples_veneto_sens.csv")[,-1]
posterior_samples_italy_sens= read.csv("counterfactuals/Italy/100_posterior_samples_italy_sens.csv")[,-1]
...
modelfit1_df_sens2 = modelfit1_df_sens %>%  
  select(! c(M_R0_M,A_R0_M,O_R0_M,Al_R0_M,pPCR_M,
             M_R0_L,A_R0_L,O_R0_L,Al_R0_L,pPCR_L,
             M_R0_U,A_R0_U,O_R0_U,Al_R0_U,pPCR_U)) 
